...
def main(page: Page):
    ...
    def shrink(e):
        ...
        page_2.controls[0].border_radius = BorderRadius(
            top_left=35,
            top_right=0,
            bottom_left=35,
            bottom_right=0
    ...
    categories = ['Work', 'Hobbies', 'Today', 'In Progress']
            ...
            Container(
                ...
                content=Column(
                    controls=[
                        ...
                        Text('40 Tasks'), # Dynamic
                        Container(
                            width=160,
                            height=5,
                            bgcolor='white12',
                            border_radius=20,
                            padding=padding.only(right=i*50), # Dynamic
                            content=Container(
                                bgcolor=PINK,
                            ),
        ...
        content=Column(
            controls=[
                ...
                Stack(
                    controls=[
                        tasks,
                        FloatingActionButton(bottom=2, right=20, bgcolor=PINK,
